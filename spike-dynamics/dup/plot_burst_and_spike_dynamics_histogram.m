...
for meaI = 1:4
    ...
    text(1,1,"Slope = "+round(coeff(2),2)+", Intercept = "+round(coeff(1),2),'FontSize',12)
    text(1,0.5,"R^2 = "+round(mdl.Rsquared.Ordinary,2),'FontSize',12)
    text(1,0.25,"P-value < 0.0001",'FontSize',12)
    title(regList{meaI})
    set(gca,'fontsize',16)
    ax = [ax tax];
    hold off
...
for meaI = 1:4
    ...
    text(10^2,1,"Slope = "+round(coeff(2),2)+", Intercept = "+round(coeff(1),2),'FontSize',12)
    text(10^2,0.5,"R^2 = "+round(mdl.Rsquared.Ordinary,2),'FontSize',12)
    text(10^2,0.25,"P-value < 0.0001",'FontSize',12)
    title(regList{meaI})
    set(gca,'fontsize',16)
    ax = [ax tax];
    hold off
...
for meaI = 1:4
    ...
    text(10^1,1,"Slope = "+round(coeff(2),2)+", Intercept = "+round(coeff(1),2),'FontSize',12)
    text(10^1,0.5,"R^2 = "+round(mdl.Rsquared.Ordinary,2),'FontSize',12)
    text(10^1,0.25,"P-value < 0.0001",'FontSize',12)
    title(regList{meaI})
    set(gca,'fontsize',16)
    ax = [ax tax];
    hold off
